...
- `in-action-cat-shellout-demo/` — a small self-hosted Orbit optimization demo that removes the autoresearch loop's manifest `cat` shell-out and proves the fix with a focused evaluator
