...
Ported from orbit src/agents/native-config.ts.
"""
...
def compose_role_instructions(
    ...
    if resolved_model:
        if not metadata_lines:
            metadata_lines.append("## Orbit Agent Metadata")
...
def generate_agent_toml(
    ...
    """Generate TOML content for a prompt-backed Orbit role agent."""
