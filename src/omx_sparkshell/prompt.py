...
def _truncate_for_prompt(text: str, label: str) -> str:
    max_lines = _read_env_int("OMX_SPARKSHELL_SUMMARY_MAX_LINES", DEFAULT_SUMMARY_MAX_LINES)
    max_bytes = _read_env_int("OMX_SPARKSHELL_SUMMARY_MAX_BYTES", DEFAULT_SUMMARY_MAX_BYTES)
