"""omx-sparkshell: Execute commands and optionally summarize large output via codex."""
...
from ..omx_mux import build_capture_pane_args
...
def _usage_text() -> str:
    return (
        f"usage: omx-sparkshell <command> [args...]\n"
        f"   or: omx-sparkshell --tmux-pane <pane-id> [--tail-lines <{MIN_TMUX_TAIL_LINES}-{MAX_TMUX_TAIL_LINES}>]\n"
        f"\n"
