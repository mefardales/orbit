...
class ConfigAuditResult:
    ...
    def to_markdown(self) -> str:
        ...
        if not self.archive_present:
            lines.append('Local archive unavailable; running in standalone mode.')
            return '\n'.join(lines)
        ...
        lines.extend([
            ...
            f'Total Python files vs registered registered modules: **{self.total_file_ratio[0]}/{self.total_file_ratio[1]}**',
...
def run_config_audit() -> ConfigAuditResult:
